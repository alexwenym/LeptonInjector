...
BOOST_PYTHON_MODULE(EarthModelService){
    ...
    class_<Vector3D>("Vector3D", init<>())
        ...
        .def("GetZ", &Vector3D::GetZ, return_value_policy<copy_const_reference>())
        .def("GetY", &Vector3D::GetY, return_value_policy<copy_const_reference>())
        .def("GetX", &Vector3D::GetX, return_value_policy<copy_const_reference>())
